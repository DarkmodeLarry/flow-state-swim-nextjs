...
function Account() {
  return (
    <div className=''>
      <Head>
        <title>Account Settings - Flow State Swim</title>
        <link rel='icon' href='/favicon.ico' />
      </Head>
      <header className={`bg-[#141414] flex justify-between w-full p-4`}>
        <Link href='/'>
          <h1 className='montserrat font-extrabold italic text-2xl tracking-tighter text-cyan-500'>
            Flow State Swim
          </h1>
        </Link>
        <Link href='/account'>
